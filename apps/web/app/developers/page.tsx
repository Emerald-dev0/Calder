    ...
    <>
      ...
      <main>
        <PageHero
          ...
          lede="Versioned from day one, errors shaped the same way every time, idempotency where a duplicate would hurt someone, and test keys that exercise the real pipeline. The interesting parts are the design and the failure messages; the protocol is deliberately dull."
        />
            ...
            <Reveal delay={100}>
              <div className="pipeline" style={{ marginTop: "2rem" }}>
                ...
                <p className="caption" style={{ marginTop: "1rem" }}>
                  Every 429 carries your limit, your remaining budget, the reset time and a
                  Retry-After, so backoff logic can be written once and trusted.
                </p>
