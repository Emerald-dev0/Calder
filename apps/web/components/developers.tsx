      ...
      <div className="wrap">
        ...
        <div className="dev-split">
          <div className="dev-sticky">
            <Reveal>
              <p className="lede">
                No sales call and no card. A test key runs the whole pipeline, queue, worker,
                events, webhooks, without a real inbox involved, so you can build the integration
                and only then decide you like it.
              </p>
