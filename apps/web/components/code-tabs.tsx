...
const SNIPPETS = {
  cURL: {
    ...
    copy: `curl https://api.avenor.com/v1/emails \\
  -H "Authorization: Bearer avenor_sk_live_…" \\
  ...
  -d '{
    ...
    body: (
      <>
        ...
        <span className="tok-str">&quot;Authorization: Bearer avenor_sk_live_…&quot;</span>{" "}
        <span className="tok-dim">\</span>
        {"\n"}
        &nbsp;&nbsp;<span className="tok-dim">-H</span>{" "}
  ...
  Node: {
    ...
    copy: `const res = await fetch("https://api.avenor.com/v1/emails", {
  method: "POST",
  headers: {
    "Authorization": "Bearer avenor_sk_live_…",
...
const { id, status } = await res.json(); // em_9f2k41xq, "queued"`,
    body: (
      <>
        ...
        <span className="tok-str">&quot;Bearer avenor_sk_live_…&quot;</span>,{"\n"}
