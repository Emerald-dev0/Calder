# Calder, Brand Identity (v1)

> **Canonical mark update.** The production identity is the board-approved system
> (`calder-symbol.svg`, `calder-wordmark.svg`, `calder-lockup.svg`,
> `calder-lockup-dark.svg`, favicon; board: `docs/brand-board.png`): an origin dot
> plus a bold route resolving into an abstract A, with the custom angular CALDER
...
Calder sits between an application and its recipient. The mark captures that
...
`A` for Calder. That double reading is the entire brand: infrastructure first,
