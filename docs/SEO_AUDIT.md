...
| 7   | Competitor-name pages removed by strategy          | P1       | Naming giants punches up in their favor              | Generic `/migrate` switching guide; no brand-named comparisons  | DONE this pass                     |
